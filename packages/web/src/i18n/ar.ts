...
export const ar = {
    ...
    'whatsapp.heading': 'واتساب',
    'whatsapp.linked': 'مرتبط',
    'whatsapp.notLinked': 'غير مرتبط — التذكيرات لا تُرسل',
    'whatsapp.scanToLink': 'من هاتف العيادة: واتساب ← الأجهزة المرتبطة ← ربط جهاز، ثم امسح هذا الرمز.',
    'whatsapp.qrUnavailable': 'في انتظار رمز الربط…',
    'whatsapp.qrRaw': 'رمز الربط كنص (الخادم لم يحوّله إلى صورة):',
    'whatsapp.dryRun': 'الوضع التجريبي: التذكيرات تُسجَّل ولا تُرسل',
    'whatsapp.lastError': 'آخر خطأ: {message}',
    'whatsapp.unlink': 'إلغاء الربط',
    ...
    'reminder.sendFailed': 'فشل إرسال رسالة التذكير.',
    'reminder.reason.started': 'الموعد كان قد بدأ بالفعل.',
    'reminder.reason.too_late': 'الوقت المتبقي على الموعد غير كافٍ.',
    'reminder.reason.cancelled': 'الموعد ملغي.',
    'reminder.reason.catch_up_cap': 'تم تجاوز حد الرسائل بعد انقطاع التشغيل.',
